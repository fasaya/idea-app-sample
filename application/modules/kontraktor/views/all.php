...
<head>
    ...
    <title>Website Kontraktor</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <link rel="icon" href="<?= base_url() ?>template/kontraktor/assets/img/favicon.ico">
    <!-- CSS
		============================================ -->
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/bootstrap.min.css">
    <!-- FontAwesome CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/font-awesome.min.css">
    <!-- Flaticon CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/flaticon.min.css">
    <!-- Slick Slider CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/plugins/slick.min.css">
    <!-- CSS Animation CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/plugins/cssanimation.min.css">
    <!-- Justified Gallery CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/plugins/justifiedGallery.min.css">
    <!-- Light Gallery CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/plugins/light-gallery.min.css">
    ...
    <!--
		...
		-->
    <!-- Main Style CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>template/kontraktor/assets/css/style.css">
</head>
<body>
    <!--====================  header area ====================-->
    <div class="header-area header-sticky bg-img space__inner--y40 background-repeat--x background-color--dark d-none d-lg-block" data-bg="<?= base_url() ?>template/kontraktor/assets/img/icons/ruler.png">
        <!-- header top -->
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="header-top-info">
                            <span class="header-top-info__image pr-1"><img src="<?= base_url() ?>template/kontraktor/assets/img/icons/phone.png" alt=""></span>
                            <span class="header-top-info__text">01225 265 847</span>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="header-top-info text-center">
                            <span class="header-top-info__image pr-1"><img src="<?= base_url() ?>template/kontraktor/assets/img/icons/clock.png" alt=""></span>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-2">
                                        <div class="brand-logo">
                                            <a href="index.html">
                                                <img src="<?= base_url() ?>template/kontraktor/assets/img/logo.png" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-lg-10">
                                                ...
                                                <ul class="d-flex justify-content-end">
                                                    ...
                                                    <li class="has-sub-menu">
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li><a href="#">Service Details Left Sidebar</a></li>
    ...
    <!--====================  End of header area  ====================-->
    <!--====================  mobile header ====================-->
    <div class="mobile-header header-sticky bg-img space__inner--y30 background-repeat--x background-color--dark d-block d-lg-none" data-bg="<?= base_url() ?>template/kontraktor/assets/img/icons/ruler.png">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="brand-logo">
                        <a href="index.html">
                            <img src="<?= base_url() ?>template/kontraktor/assets/img/logo-white.png" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-6">
                    ...
                    <ul>
                        ...
                        <li class="menu-item-has-children">
                            ...
                            <ul class="sub-menu-mobile">
                                <li><a href="#">Service Page</a></li>
                                <li><a href="#">Service Details Left Sidebar</a></li>
                                <li><a href="#">Service Details Right Sidebar</a></li>
                                <li class="menu-item-has-children">
                                    <a href="#">Submenu Level One</a>
                                    <ul class="sub-menu-mobile">
                                        <li><a href="#">Submenu Level Two</a></li>
                    ...
                    <div class="off-canvas-contact-widget">
                        <div class="header-contact-info">
                            <ul class="header-contact-info__list">
                                ...
                                <li><i class="fa fa-user"></i> <a href="#">Login / Register</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="hero-slider-area space__bottom--r120">
        <div class="hero-slick-slider-wrapper">
            <div class="single-hero-slider single-hero-slider--background single-hero-slider--overlay position-relative bg-img" data-bg="<?= base_url() ?>template/kontraktor/assets/img/hero-slider/hero-slider-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- hero slider content -->
            ...
            <div class="single-hero-slider single-hero-slider--background single-hero-slider--overlay position-relative bg-img" data-bg="<?= base_url() ?>template/kontraktor/assets/img/hero-slider/hero-slider-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <!-- hero slider content -->
            ...
            <div class="row align-items-center row-25">
                <div class="col-md-6">
                    <div class="about-image space__bottom__lm--30">
                        <img src="<?= base_url() ?>template/kontraktor/assets/img/about/about-section-1.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                    ...
                    <div class="feature-content-wrapper space__bottom--m35">
                        <div class="single-feature space__bottom--35">
                            <div class="single-feature__icon">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/icons/feature-1.png" class="img-fluid" alt="">
                            </div>
                        ...
                        <div class="single-feature space__bottom--35">
                            <div class="single-feature__icon">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/icons/feature-2.png" class="img-fluid" alt="">
                            </div>
                            <div class="single-feature__content">
                        ...
                        <div class="single-feature space__bottom--35">
                            <div class="single-feature__icon">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/icons/feature-3.png" class="img-fluid" alt="">
                            </div>
                            <div class="single-feature__content">
                ...
                <div class="col-lg-6 space__bottom__md--40 space__bottom__lm--40 order-1 order-lg-2">
                    ...
                    <div class="feature-content-image">
                        <img src="<?= base_url() ?>template/kontraktor/assets/img/feature/feature-banner-1.jpg" class="img-fluid" alt="">
                        <img src="<?= base_url() ?>template/kontraktor/assets/img/feature/feature-banner-2.jpg" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-5">
                    ...
                    <div class="service-banner space__bottom__md--40 space__bottom__lm--40">
                        <img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-man.png" class="float-none float-lg-right" alt="">
                    </div>
                </div>
                    ...
                    <div class="row service-slider-wrapper space__bottom__md--40 space__bottom__lm--40">
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-1.jpg" class="img-fluid" alt=""></a>
                            </div>
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-2.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-3.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-4.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-5.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
                        ...
                        <div class="col single-service text-center">
                            <div class="single-service__image space__bottom--15">
                                <a href="service.html"><img src="<?= base_url() ?>template/kontraktor/assets/img/service/service-6.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <h4 class="single-service__content">
    ...
    <div class="fun-fact-area space__bottom--r120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!-- fun fact wrapper -->
                    <div class="fun-fact-wrapper fun-fact-wrapper-bg bg-img" data-bg="<?= base_url() ?>template/kontraktor/assets/img/backgrounds/funfact-bg.jpg">
                        <div class="fun-fact-inner background-color--default-overlay background-repeat--x-bottom space__inner--y30 bg-img" data-bg="<?= base_url() ?>template/kontraktor/assets/img/icons/ruler-black.png">
        ...
        <div class="project-wrapper space__bottom--m5" id="project-justify-wrapper">
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project1.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Western Shopping Mall</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project2.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">City Flyover</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project3.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Highway Carpeting</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project4.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">House Infrustructure Making</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project5.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Wooden House</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project6.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Road Repairing</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project7.jpg" class="img-fluid" alt="">
                    <span class="single-project-title">Apartment Building</span>
                </a>
            </div>
            <div class="single-project-wrapper">
                <a class="single-project-item" href="project-details.html">
                    <img src="<?= base_url() ?>template/kontraktor/assets/img/projects/project8.jpg" class="img-fluid" alt="">
                    ...
                    <div class="team-slider-wrapper row">
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/team/team-member1.jpg" alt="">
                            </div>
                        ...
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/team/team-member2.jpg" alt="">
                            </div>
                        ...
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/team/team-member3.jpg" alt="">
                            </div>
                        ...
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/team/team-member4.jpg" alt="">
                            </div>
                        ...
                        <div class="single-team-member col text-center">
                            <div class="single-team-member__image space__bottom--10">
                                <img src="<?= base_url() ?>template/kontraktor/assets/img/team/team-member5.jpg" alt="">
                            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 space__bottom__md--40 space__bottom__lm--40">
                    <!-- cta block -->
                    <div class="cta-block cta-block--shadow cta-block--bg bg-img" data-bg="<?= base_url() ?>template/kontraktor/assets/img/backgrounds/cta-bg.jpg">
                        ...
                        <div class="row">
                                ...
                                <div class="single-blog-grid space__bottom--40">
                                    <div class="single-blog-grid__image space__bottom--15">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="<?= base_url() ?>template/kontraktor/assets/img/blog/grid1.jpg" class="img-fluid" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="single-blog-grid space__bottom--40">
                                    <div class="single-blog-grid__image space__bottom--15">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="<?= base_url() ?>template/kontraktor/assets/img/blog/grid2.jpg" class="img-fluid" alt="">
                                        </a>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="single-blog-grid space__bottom--40">
                                    <div class="single-blog-grid__image space__bottom--15">
                                        <a href="blog-details-left-sidebar.html">
                                            <img src="<?= base_url() ?>template/kontraktor/assets/img/blog/grid3.jpg" class="img-fluid" alt="">
                                        </a>
                                    </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="brand-logo-wrapper">
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?= base_url() ?>template/kontraktor/assets/img/brand-logo/logo1.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?= base_url() ?>template/kontraktor/assets/img/brand-logo/logo2.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?= base_url() ?>template/kontraktor/assets/img/brand-logo/logo3.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?= base_url() ?>template/kontraktor/assets/img/brand-logo/logo4.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?= base_url() ?>template/kontraktor/assets/img/brand-logo/logo5.png" class="img-fluid" alt=""></a>
                        </div>
                        <div class="single-brand-logo">
                            <a href="#"><img src="<?= base_url() ?>template/kontraktor/assets/img/brand-logo/logo4.png" class="img-fluid" alt=""></a>
                        </div>
    ...
    <!--====================  newsletter area ====================-->
    <div class="newsletter-area newsletter-area-bg bg-img" data-bg="<?= base_url() ?>template/kontraktor/assets/img/backgrounds/newsletter-bg.jpg">
    ...
    <!--====================  footer area ====================-->
    <div class="footer-area bg-img space__inner--ry120" data-bg="<?= base_url() ?>template/kontraktor/assets/img/backgrounds/footer-bg.jpg">
        <div class="container">
            <div class="row">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p class="copyright-text">Copyright &copy; <a href="#">Idea</a>, All Rights Reserved - 2019</p>
                </div>
            </div>
        </div>
    </div>
    ...
    ============================================ -->
    <!-- Modernizer JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/modernizr-2.8.3.min.js"></script>
    <!-- jQuery JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/jquery-3.4.1.min.js"></script>
    <!-- Bootstrap JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/bootstrap.min.js"></script>
    <!-- Popper JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/popper.min.js"></script>
    <!-- Slick slider JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/slick.min.js"></script>
    <!-- Counterup JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/counterup.min.js"></script>
    <!-- Waypoint JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/waypoint.min.js"></script>
    <!-- Justified Gallery JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/justifiedGallery.min.js"></script>
    <!-- Image Loaded JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/imageloaded.min.js"></script>
    <!-- Maosnry JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/masonry.min.js"></script>
    <!-- Light Gallery JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/light-gallery.min.js"></script>
    <!-- Mailchimp JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/plugins/mailchimp-ajax-submit.min.js"></script>
    <!-- Plugins JS (Please remove the comment from below plugins.min.js for better website load performance and remove plugin js files from avobe) -->
    <!--
    <script src="assets/js/plugins/plugins.min.js"></script>
    -->
    <!-- Main JS -->
    <script src="<?= base_url() ?>template/kontraktor/assets/js/main.js"></script>
</body>
</html>